(() => {
    ...
    new Swiper(".main-slider", {
        ...
        // loop: !0,
        navigation: {
            prevEl: ".header-catalog__control-r",
            nextEl: ".header-catalog__control-l"
        },
        breakpoints: {
            320: {
                slidesPerView: 2,
        ...
        // loop: !0,
        navigation: {
            prevEl: ".cheaper-catalog__control-r",
            nextEl: ".cheaper-catalog__control-l"
        },
        breakpoints: {
            320: {
                slidesPerView: 2,
...
// let adressFormInputs = document.querySelectorAll('.adress-form__input');
// let userFormInputs = document.querySelectorAll('.user-form__input');
    

// for (let index = 0; index < adressFormInputs.length; index++) {
//     const adressFormInput = adressFormInputs[index];
//     adressFormInput.addEventListener('onkeyup', validRegistrationOrder)
// }
// for (let index = 0; index < userFormInputs.length; index++) {
//     const userFormInput = userFormInputs[index];
//     userFormInput.addEventListener('onkeyup', validRegistrationOrder)
// }

// adressFormInputs.forEach(element => {
//     element.addEventListener('click onkeyup', validRegistrationOrder())
// });
// userFormInputs.forEach(element => {
//     element.addEventListener('click onkeyup', validRegistrationOrder())
// });