...
if (document.querySelector('.registration-order-wrap')) {
    ...
    let payBtnsParent = document.querySelector('.radiobuttons2');
...
if (selfDeliveryStatus === false) {
    ...
    function validRegistrationOrder() {
        ...
        // let index = document.querySelector('.adress-form__input-index');
        // let city = document.querySelector('.adress-form__input-city');
        // let adress = document.querySelector('.adress-form__input-adres');
